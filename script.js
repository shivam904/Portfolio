...
window.addEventListener('scroll', () => {
    if (window.scrollY > 100) {
        ...
        navbar.style.borderBottom = '1px solid rgba(139, 92, 246, 0.2)';
    }
});
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.skill-category, .project-card, .stat-item, .about-avatar, .hero-avatar');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (heroTitle) {
        ...
        if (!heroTitle.textContent.includes('Hi, I\'m')) {
            heroTitle.innerHTML = 'Hi, I\'m <span class="highlight">' + highlightText + '</span>';
        }
        
        // Then animate the highlight part
        const newHighlight = heroTitle.querySelector('.highlight');
        if (newHighlight && highlightText) {
            // Clear the highlight text first
            newHighlight.textContent = '';
